        ...
        <div className="h-full w-full absolute pointer-events-none">
            <svg height="100%" viewBox="0 0 1595 823" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMax slice" className="w-full h-full opacity-40">
                <g clipPath="url(#clip0_386_2)">
                    ...
                    }} ref={line3} d="M245.501 -18.9185C340.501 67.6728 457.001 261.637 163.001 344.765C-204.499 448.674 -99.4993 209.355 -231.999 219.582C-364.499 229.81 -433.999 596.357 -222.999 590.22C-11.9993 584.084 481 427.811 501 826.676C521 1225.54 601 914.222 595.5 805.812C590 697.403 708.5 730.948 734 743.221C759.5 755.494 820 791.085 856 826.676" stroke="var(--primary-color)" strokeWidth="2" />
                    <motion.path initial={{
                    ...
                    }} ref={line4} d="M1597.5 594.72C1442.5 592.266 1289.5 673.675 1326.5 822.585" stroke="var(--primary-color)" strokeWidth="2" />
                </g>
